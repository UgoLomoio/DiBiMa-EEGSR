        ...
        for sr_type in sr_types:
            ...
            if sr_type == "temporal":
                ...
                for downsample_factor in downsample_factors:
                    ...
                    #models_nn_temporal[f'base_x{downsample_factor}'] = DCAE_SR_nn(num_channels=num_channels, fs_lr=fs_lr, fs_hr=fs_hr, seconds=seconds, residual_global=False, residual_internal=False, use_subpixel=False, sr_type=sr_type),
                    #models_nn[f'with_subpixel_x{downsample_factor}'] = DCAE_SR_nn(num_channels=num_channels, fs_lr=fs_lr, fs_hr=fs_hr, seconds=seconds, residual_global=False, residual_internal=False, use_subpixel=True, sr_type=sr_type),
                    #models_nn[f'with_subpixel_internal_residual_x{downsample_factor}'] = DCAE_SR_nn(num_channels=num_channels, fs_lr=fs_lr, fs_hr=fs_hr, seconds=seconds, residual_global=False, residual_internal=True, use_subpixel=True, sr_type=sr_type),
                    models_nn[f'with_subpixel_and_both_residuals_x{downsample_factor}'] = DCAE_SR_nn(num_channels=num_channels, fs_lr=fs_lr, fs_hr=fs_hr, seconds=seconds, residual_global=True, residual_internal=True, use_subpixel=True, sr_type=sr_type)   
                ...
                for num_channels in nums_channels:
                    models_nn[f'with_subpixel_and_both_residuals_{num_channels}to64chs'] = DCAE_SR_nn(num_channels=num_channels, fs_lr=fs_hr, fs_hr=fs_hr, seconds=seconds, residual_global=True, residual_internal=True, use_subpixel=True, sr_type=sr_type)
